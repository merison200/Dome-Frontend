...
//       // Close details modal if it's the same transfer
...
//         <StatCard
//           title="Total Amount"
//           value={paymentAPI.formatCurrency(
...
//               <div key={transfer.transactionId} className="p-6 hover:bg-gray-50 transition-colors">
