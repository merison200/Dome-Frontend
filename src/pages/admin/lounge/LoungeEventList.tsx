...
import { Plus, Calendar, Clock, Edit3, XCircle } from 'lucide-react';
import { loungeAPI, Lounge } from '../../../services/lounge';
import ConfirmModal from '../../../components/ui/ConfirmModal';
import toast from 'react-hot-toast';

const LoungeEventList: React.FC = () => {
  const [events, setEvents] = useState<Lounge[]>([]);
  ...
  const handleDelete = async () => {
    if (!confirmId) return;
    try {
      await loungeAPI.delete(confirmId);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Lounge Events</h1>
              <p className="text-gray-600 text-sm mt-1">Manage event listings</p>
            </div>
            <Link
              to="/admin/lounge/events/new"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {events.map((event) => (
            ...
            >
              ...
              <div className="p-4">
                <Link
                  to={`/admin/lounge/events/${event._id}`}
                ...
                <div className="flex gap-2 mt-4 pt-4 border-t border-gray-100">
                  <Link
                    to={`/admin/lounge/events/${event._id}/edit`}
...
export default LoungeEventList;