...
//         {[
//           { label: 'Total Inquiries', count: inquiries.length, color: 'bg-blue-500', icon: Mail },
//           { label: 'Pending', count: inquiries.filter(i => i.status === 'pending').length, color: 'bg-yellow-500', icon: Clock },
//           { label: 'Replied', count: inquiries.filter(i => i.status === 'replied').length, color: 'bg-green-500', icon: CheckCircle },
//           { label: 'Closed', count: inquiries.filter(i => i.status === 'closed').length, color: 'bg-gray-500', icon: XCircle }
//         ].map((stat, index) => (
...
//               className="pl-10 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent appearance-none bg-white min-w-36"
//             >
...
//                           Replied: {formatDate(inquiry.lastRepliedAt)}
//                         </div>
//                       )}
//                     </td>
...
//                           onChange={(e) => handleStatusUpdate(inquiry._id!, e.target.value as any)}
...
//                 <h3 className="font-semibold text-gray-900 mb-2">Original Inquiry</h3>
//                 <div className="text-sm text-gray-600 mb-2">
//                   <span className="font-medium">{selectedInquiry.name}</span> ({selectedInquiry.email})
//                 </div>
...
//                     <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(selectedInquiry.status)}`}>
...
//                           <h4 className="font-medium text-gray-900">{reply.subject}</h4>
...
//                           <span className="font-medium">Replied by:</span> {reply.repliedBy}
//                         </div>
//                       </div>
//                     ))}
//                   </div>
