...
//               className="w-full bg-blue-600 dark:bg-blue-700 text-white py-3 rounded-xl font-semibold hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors flex items-center justify-center space-x-2"
//             >
...
//               className="w-full bg-gray-600 dark:bg-gray-700 text-white py-3 rounded-xl font-semibold hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors"
//             >
//               Browse Halls
//             </button>
//           </div>
...
//                     : 'border-orange-500 bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-400 hover:bg-orange-100 dark:hover:bg-orange-900/30'
//                 }`}
//               >
//                 {emailSending ? (
...
//                   className="w-full p-4 rounded-xl border-2 border-purple-500 bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-400 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-all duration-300 flex items-center justify-center space-x-2"
//                 >
//                   {downloading ? (
//                     <Loader className="w-5 h-5 animate-spin" />
//                   ) : (
...
//           {/* Payment Breakdown */}
//           <div className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-2xl p-6 mb-8">
...
//             <h4 className="text-lg font-bold text-blue-900 dark:text-blue-200 mb-4">What's Next?</h4>
//             <div className="space-y-3 text-sm text-blue-800 dark:text-blue-300">
//               <div className="flex items-start space-x-3">
//                 <span className="w-6 h-6 bg-blue-200 dark:bg-blue-700 text-blue-800 dark:text-blue-200 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">1</span>
//                 <span>You have received a confirmation email with event details</span>
//               </div>
//               <div className="flex items-start space-x-3">
//                 <span className="w-6 h-6 bg-blue-200 dark:bg-blue-700 text-blue-800 dark:text-blue-200 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">2</span>
//                 <span>Our team will contact you 48 hours before your event</span>
//               </div>
//               <div className="flex items-start space-x-3">
//                 <span className="w-6 h-6 bg-blue-200 dark:bg-blue-700 text-blue-800 dark:text-blue-200 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">3</span>
...
//             <button
//               onClick={() => navigate('/halls')}
//               className="bg-gradient-to-r from-red-600 to-red-700 text-white py-4 rounded-xl font-semibold hover:from-red-700 hover:to-red-800 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
//             >
...
//             <button
//               onClick={() => navigate('/')}
//               className="bg-gray-600 dark:bg-gray-700 text-white py-4 rounded-xl font-semibold hover:bg-gray-700 dark:hover:bg-gray-600 transition-all duration-300 flex items-center justify-center space-x-2"
//             >
