...
//     switch (status) {
//       case 'loading':
//         return <Loader className="w-16 h-16 text-blue-600 dark:text-blue-400 animate-spin" />;
//       case 'success':
...
//         {/* Status Message */}
//         <div className={`rounded-2xl border-2 p-6 mb-6 ${getBackgroundColor()}`}>
...
//               className="w-full bg-blue-600 dark:bg-blue-700 text-white py-3 rounded-xl font-semibold hover:bg-blue-700 dark:hover:bg-blue-800 transition-colors"
//             >
//               Contact Support
//             </button>
//             <button
//               onClick={() => navigate('/dashboard')}
//               className="w-full bg-gray-600 dark:bg-gray-700 text-white py-3 rounded-xl font-semibold hover:bg-gray-700 dark:hover:bg-gray-800 transition-colors"
//             >
//               Go to Dashboard
//             </button>
...
//                 className="w-full bg-green-600 dark:bg-green-700 text-white py-3 rounded-xl font-semibold hover:bg-green-700 dark:hover:bg-green-800 transition-colors"
//               >
