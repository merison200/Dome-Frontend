...
//     if (!user) return '';
//     if (user.name) {
//       // Get the first name (part before the first space)
//       const firstName = user.name.split(' ')[0];
//       return `👋 ${firstName}`;
//     }
//     // If no name, use the part before @ from email
...
//   return (
//     <>
//       <nav className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-md shadow-lg sticky top-0 z-50 transition-colors">
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="flex justify-between h-16">
//             {/* Brand */}
//             <div className="flex items-center">
//               <Link to="/" className="flex items-center space-x-3">
//                 <div className="w-12 h-12 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
//                   <img 
//                     src={domeLogo} 
//                     alt="The Dome Logo" 
...
//                   <span className="text-xl font-bold bg-gradient-to-r from-[#dc2626] to-[#1e3a8a] bg-clip-text text-transparent">
//                     The Dome
//                   </span>
//                 </div>
//               </Link>
...
//                   key={item.name}
//                   to={item.href}
//                   className={`text-sm font-medium transition-colors hover:text-[#dc2626] dark:hover:text-[#dc2626] ${
//                     location.pathname === item.href
//                       ? 'text-[#dc2626] dark:text-[#dc2626] border-b-2 border-[#dc2626] dark:border-[#dc2626]'
...
//               <button
//                 onClick={toggleTheme}
//                 className="p-2 text-gray-600 dark:text-gray-400 hover:text-[#dc2626] dark:hover:text-[#dc2626] transition-colors rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800"
//               >
...
//                       className="bg-gradient-to-r from-[#dc2626] to-[#1e3a8a] text-white p-2 rounded-full hover:from-red-700 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg"
//                     >
...
//                       onClick={handleDashboardClick}
//                       title="My Profile"
//                       className="bg-gradient-to-r from-[#059669] to-[#0d9488] text-white p-2 rounded-full hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 shadow-md hover:shadow-lg"
//                     >
...
//                   <button
//                     onClick={logout}
//                     className="flex items-center space-x-1 text-gray-700 dark:text-gray-300 hover:text-[#dc2626] dark:hover:text-[#dc2626] transition-colors"
//                   >
...
//                     className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-[#dc2626] dark:hover:text-[#dc2626] transition-colors"
//                   >
//                     Login
//                   </button>
//                   <button
//                     onClick={() => handleAuthClick('signup')}
//                     className="bg-gradient-to-r from-[#dc2626] to-[#1e3a8a] text-white px-4 py-2 rounded-lg text-sm font-medium hover:from-red-700 hover:to-blue-700 transition-all duration-300 shadow-md hover:shadow-lg"
//                   >
//                     Sign Up
//                   </button>
//                 </div>
...
//               <button
//                 onClick={toggleTheme}
//                 className="p-2 text-gray-700 dark:text-gray-300 hover:text-[#dc2626] dark:hover:text-[#dc2626] transition-colors"
//               >
//                 {isDark ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
//               </button>
//               <button
//                 onClick={() => setIsOpen(!isOpen)}
//                 className="text-gray-700 dark:text-gray-300 hover:text-[#dc2626] dark:hover:text-[#dc2626] transition-colors"
//               >
...
//         {/* Mobile Navigation */}
//         {isOpen && (
//           <div className="md:hidden bg-white dark:bg-gray-900 border-t shadow-lg transition-colors">
//             <div className="px-2 pt-2 pb-3 space-y-1">
//               {navigation.map((item) => (
//                 <Link
//                   key={item.name}
//                   to={item.href}
//                   className="block px-3 py-2 text-base font-medium text-gray-700 dark:text-gray-300 hover:text-[#dc2626] dark:hover:text-[#dc2626] hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md transition-colors"
...
//                         setIsOpen(false);
//                       }}
//                       className="block px-3 py-2 text-base font-medium text-[#dc2626] dark:text-[#dc2626] hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-colors w-full text-left"
//                     >
...
//                         setIsOpen(false);
//                       }}
//                       className="block px-3 py-2 text-base font-medium text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded-md transition-colors w-full text-left"
//                     >
//                       My Profile
//                     </button>
//                   )}
...
//                       setIsOpen(false);
//                     }}
//                     className="block w-full text-left px-3 py-2 text-base font-medium text-gray-700 dark:text-gray-300 hover:text-red-600 dark:hover:text-red-400 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md transition-colors"
//                   >
//                     Logout
//                   </button>
//                 </div>
...
//                   <button
//                     onClick={() => handleAuthClick('login')}
//                     className="block w-full text-left px-3 py-2 text-base font-medium text-gray-700 dark:text-gray-300 hover:text-[#dc2626] dark:hover:text-[#dc2626] hover:bg-gray-50 dark:hover:bg-gray-800 rounded-md transition-colors"
//                   >
//                     Login
//                   </button>
//                   <button
//                     onClick={() => handleAuthClick('signup')}
//                     className="block w-full text-left px-3 py-2 text-base font-medium text-[#dc2626] dark:text-[#dc2626] hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-colors"
//                   >
//                     Sign Up
//                   </button>
//                 </div>
